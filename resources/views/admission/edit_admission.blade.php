		...
		<div class="card">
			<div class="card-body">
				<div class="card-block">
					...
					@endif
					<br>
					<form class="form-body" method="post" action="{{ url('admission/update') }}" enctype="multipart/form-data">	
						@csrf
						<h3 class="form-section-hm">Edit Admission Form</h3>
						<h3 class="form-section-h">Personal Details</h3>
						
						<div class="form-group row">
							<div class="col-sm-4">
								<input type="hidden" name="admission_id" value="{{ $data['admission']->id }}">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="college_enrollment_number" value="{{ $data['admission']->college_enrollment_number }}" class="form-control" placeholder="Enter College Enrollment">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="university_enrollment_number" value="{{ $data['admission']->university_enrollment_number }}" class="form-control" placeholder="Enter University Enrollment">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input type="text" name="first_name" value="{{ $data['admission']->first_name }}" class="form-control" placeholder="Enter First Name">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="middle_name" value="{{ $data['admission']->middle_name }}" class="form-control" placeholder="Enter Middle Name">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="last_name" value="{{ $data['admission']->last_name }}"  class="form-control" placeholder="Enter Last Name">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input type="date" name="dob" value="{{ $data['admission']->dob }}" class="form-control">
								@if($errors->has('dob'))
							...
							<div class="col-sm-4">
								...
								<input type="number" name="mobile_number" value="{{ $data['admission']->mobile_number }}" class="form-control" placeholder="Enter Mobile Number">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="email" value="{{ $data['admission']->email }}" class="form-control" placeholder="Enter Email ID">
								@if($errors->has('email'))
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<select class="form-control" name="gender">
									...
									@if($data['admission']->gender == 'Male')
										<option value="Male" selected="">Male</option>
									@elseif($data['admission']->gender == 'Female')
							...
							<div class="col-sm-4">
								...
								<select class="form-control" name="category_id">
									...
									@foreach($data['categories'] as $category)
										@if($data['admission']->category_id == $category->id)
							...
							<div class="col-sm-4">
								...
								<input type="text" name="current_address" value="{{ $data['admission']->current_address }}" class="form-control" placeholder="Enter Current Address">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<select class="form-control" name="id_type">
									...
									@foreach($data['id_types'] as $idtype)
										@if($data['admission']->id_type == $idtype->id)
							...
							<div class="col-sm-4">
								...
								<input type="text" name="id_number" value="{{ $data['admission']->id_number }}" class="form-control" placeholder="Enter ID Number">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="nationality" value="{{ $data['admission']->nationality }}" class="form-control" placeholder="Enter Nationality">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<select class="form-control" name="state_id">
									...
									@foreach($data['states'] as $state)
										@if($data['admission']->state_id == $state->id)
							...
							<div class="col-sm-4">
								...
								<select class="form-control" name="city_id">
									...
									@foreach($data['cities'] as $city)
										@if($data['admission']->city_id == $city->id)
							...
							<div class="col-sm-4">
								...
								<input type="text" name="pin_code" value="{{ $data['admission']->pin_code }}" class="form-control" placeholder="Enter Pincode">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input type="text" name="father_name" value="{{ $data['admission']->father_name }}" class="form-control" placeholder="Enter Father's Name">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="father_mobile_number" value="{{ $data['admission']->father_mobile_number }}" class="form-control" placeholder="Enter Father's Mobile No.">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="father_occupation" value="{{ $data['admission']->father_occupation }}" class="form-control" placeholder="Enter Father's Occupation">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input type="text" name="mother_name" value="{{ $data['admission']->mother_name }}" class="form-control" placeholder="Enter Mother's Name">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="mother_mobile_number" value="{{ $data['admission']->mother_mobile_number }}" class="form-control" placeholder="Enter Mother's Mobile No.">
							...
							<div class="col-sm-4">
								...
								<input type="text" name="mother_occupation" value="{{ $data['admission']->mother_occupation }}" class="form-control" placeholder="Enter Mother's Occupation">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-fitems">
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control-s" name="high_school_passing_year" value="{{ $data['admission']->high_school_passing_year }}">
												@if($errors->has('high_school_passing_year'))
													<span style="color: red;">{{ $errors->first('high_school_passing_year') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="high_school_passing_board" value="{{ $data['admission']->high_school_passing_board }}">
												@if($errors->has('high_school_passing_board'))
													<span style="color: red;">{{ $errors->first('high_school_passing_board') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="high_school_percentage" value="{{ $data['admission']->high_school_percentage }}">
												@if($errors->has('high_school_percentage'))
													<span style="color: red;">{{ $errors->first('high_school_percentage') }}</span>
												@endif
											</td>
											<td>
												<input type="file" class="form-control-s" name="high_school_file" >
										...
										<tr>
											<td>Sr.Secondary</td>
											<td>
												<input type="text" class="form-control-s" name="sr_secondry_passing_year" value="{{ $data['admission']->sr_secondry_passing_year }}">
												@if($errors->has('sr_secondry_passing_year'))
													<span style="color: red;">{{ $errors->first('sr_secondry_passing_year') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="sr_secondry_passing_board" value="{{ $data['admission']->sr_secondry_passing_board }}">
												@if($errors->has('sr_secondry_passing_board'))
													<span style="color: red;">{{ $errors->first('sr_secondry_passing_board') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="sr_secondry_percentage" value="{{ $data['admission']->sr_secondry_percentage }}">
												@if($errors->has('sr_secondry_percentage'))
													<span style="color: red;">{{ $errors->first('sr_secondry_percentage') }}</span>
												@endif
											</td>
											<td>
												<input type="file" class="form-control-s" name="sr_secondry_file" >
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control-s" name="graduation_passing_year" value="{{ $data['admission']->graduation_passing_year }}">
												@if($errors->has('graduation_passing_year'))
													<span style="color: red;">{{ $errors->first('graduation_passing_year') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="graduation_passing_board" value="{{ $data['admission']->graduation_passing_board }}">
												@if($errors->has('graduation_passing_board'))
													<span style="color: red;">{{ $errors->first('graduation_passing_board') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="graduation_percentage" value="{{ $data['admission']->graduation_percentage }}">
										...
										<tr>
											<td>Post Grad.</td>
											<td>
												<input type="text" class="form-control-s" name="post_graduation_passing_year" value="{{ $data['admission']->post_graduation_passing_year }}">
												@if($errors->has('post_graduation_passing_year'))
													<span style="color: red;">{{ $errors->first('post_graduation_passing_year') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="post_graduation_passing_board" value="{{ $data['admission']->post_graduation_passing_board }}">
												@if($errors->has('post_graduation_passing_board'))
													<span style="color: red;">{{ $errors->first('post_graduation_passing_board') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="post_graduation_percentage" value="{{ $data['admission']->post_graduation_percentage }}">
										...
										<tr>
											<td>M.Phil</td>
											<td>
												<input type="text" class="form-control-s" name="m_phil_passing_year" value="{{ $data['admission']->m_phil_passing_year }}">
												@if($errors->has('m_phil_passing_year'))
													<span style="color: red;">{{ $errors->first('m_phil_passing_year') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="m_phil_passing_board" value="{{ $data['admission']->m_phil_passing_board }}">
												@if($errors->has('m_phil_passing_board'))
													<span style="color: red;">{{ $errors->first('m_phil_passing_board') }}</span>
												@endif
											</td>
											<td>
												<input type="text" class="form-control-s" name="m_phil_percentage" value="{{ $data['admission']->m_phil_percentage }}">
							...
							<div class="col-sm-3">
								...
								<select class="form-control" name="course_id" id="course_id" onchange="getTotalFees()">
									...
									@foreach($data['courses'] as $course)
										@if($data['admission']->course_id == $course->id)
							...
							<div class="col-sm-3">
								...
								<select class="form-control" name="branch_id">
									...
									@foreach($data['colleges'] as $college)
										@if($data['admission']->branch_id == $college->id)
							...
							<div class="col-sm-3">
								...
								<select class="form-control" name="study_mode_id">
									...
									@foreach($data['study_modes'] as $studeMode)
										@if($data['admission']->study_mode_id == $studeMode->id)
							...
							<div class="col-sm-3">
								...
								<select class="form-control" name="mode_of_entry_id">
									...
									@foreach($data['modes_of_entries'] as $entry)
										@if($data['admission']->mode_of_entry_id == $entry->id)
							...
							<div class="col-sm-4">
								...
								<select class="form-control" name="university_id">
									...
									@foreach($data['universities'] as $university)
										@if($data['admission']->university_id == $university->id)
							...
							<div class="col-sm-4">
								...
								<select class="form-control" name="session_id">
									...
									@foreach($data['sessions'] as $session)
										@if($data['admission']->session_id == $session->id)
							...
							<div class="col-sm-4">
								...
								<select class="form-control" name="mode_of_study_id">
									...
									@foreach($data['mode_of_studies'] as $study)
										@if($data['admission']->mode_of_study_id == $study->id)
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input type="text" class="form-control" placeholder="Consultant Code" name="consultant_code" value="{{ $data['admission']->consultant_code }}">
							...
							<div class="col-sm-4">
								...
								<input type="text" class="form-control" placeholder="Enter Consultant Name" name="consultant_name" value="{{ $data['admission']->consultant_name }}">
							...
							<div class="col-sm-4">
								...
								<input type="text" class="form-control" placeholder="Enter Consultant Mob" name="consultant_mobile_number" value="{{ $data['admission']->consultant_mobile_number }}">
						...
						<div class="form-group row">
							<div class="col-sm-12">
								...
								<input type="text" class="form-control" placeholder="Enter Consultant Address" name="consultant_address" value="{{ $data['admission']->consultant_address }}">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<input type="number" class="form-control" value="{{ $data['admission']->admission_fees }}" id="admission_fees" name="admission_fees" readonly="">
							...
							<div class="col-sm-4">
								...
								<select class="form-control" name="course_completion_id">
									...
									@foreach($data['completion'] as $complete)
										@if($data['admission']->course_completion_id == $complete->id)
						...
						<div class="form-group row">
							<div class="col-sm-12 text-center">
								<button type="submit" class="btn btn-dark">Update & Proceed to Next Step</button>
							</div>
						</div>
					</form>
				</div>
    ...
    <div class="modal-content"> 
      ...
      <div class="modal-body">
		 <table class="table table-bordered table-fitems">
		 	<tr>
				<th>Admission Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="fees">{{ $data['admission']->getCourse['admission_fees'] }}</span></td> 
				<th>Course Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="course_fees">{{ $data['admission']->getCourse['course_fees'] }}</span></td> 
			</tr> 
			<tr>
				<th>Exam Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="exam_fees">{{ $data['admission']->getCourse['exam_fees'] }}</span></td> 
				<th>ITP Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="itp_fees">{{ $data['admission']->getCourse['itp_fees'] }}</span></td> 
			</tr> 
			<tr>
				<th>Late Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="late_fees">{{ $data['admission']->getCourse['late_fees'] }}</span></td> 
				<th>Total Deposit Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="total_fees">{{ $data['admission']->getCourse['total_deposite_fees'] }}</span></td> 
			</tr> 
			<tr>
				<th>Hostel Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="hostel_fees">{{ $data['admission']->getCourse['hostel_fees'] }}</span></td> 
				<th>Other Fee</th> 
				<td><i class="fas fa-rupee-sign"></i> <span id="other_fees">{{ $data['admission']->getCourse['other_fees'] }}</span></td> 
			</tr> 
			 
			 <tr>
			 	<th>Other Fee Remark</th>
				<td colspan="3"><span id="remark">{{ $data['admission']->getCourse['other_fees_remark'] }}</span></td>
			 </tr>
		 </table>
      </div>
    </div>
