...
class AdmissionController extends Controller
{
	...
	*/
    public function index() {
    	...
    	return view('admission.admission_form', compact('data'));
    }
	...
	*/
    public function createAdmission(Request $request) {
		...
		return redirect('admission/preview/'.$createAdmission->id);
    }
	...
	* @link
	*/
    public function admissionPreview($id) {
    	...
    	return view('admission.admission_preview', compact(['data', 'payment_modes']));
    }
	...
	*/
    public function editView($id) {
    	...
    	return view('admission.edit_admission', compact('data'));
    }
	...
	*/
    public function updateAdmission(Request $request) {
		...
		return redirect('admission/preview/'.$picked->id)->with('success','Record Updated Successfully.');
    }
